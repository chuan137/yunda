...
USERENA_KEHU_NUMBER_SEQ_CODE = getattr(settings, 'USERENA_KEHU_NUMBER_SEQ_CODE', 'c_id')

USERENA_CUSTOMER_NUMBER_SEQ_CODE = getattr(settings, 'USERENA_CUSTOMER_NUMBER_SEQ_CODE', 'c_id')

USERENA_KEHU_NUMBER_PREFIX = getattr(settings, 'USERENA_KEHU_NUMBER_PREFIX', 'Y')

USERENA_CUSTOMER_NUMBER_PREFIX = getattr(settings, 'USERENA_CUSTOMER_NUMBER_PREFIX', 'K')

USERENA_ACTIVATED_REDIRECT_URL = getattr(settings, 'USERENA_ACTIVATED_REDIRECT_URL', False)
