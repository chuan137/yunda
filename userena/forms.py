...
class SignupForm(forms.Form):
    ...
    deposit_currency_type = forms.ChoiceField(label=_("Deposit currency"),
                                              required=True,
                                              choices=CURRENCY_TYPES,
                                              help_text=_("If you need different currency as deposit, need sign another account up."))
    ...
    def save(self):
        ...
        deposit_currency_type=self.cleaned_data['deposit_currency_type']
        new_user.userprofile.deposit_currency_type=deposit_currency_type
